...
uint256 hashGenesisBlock("0xf1a95e1ccffae995267f42bf39b843cca6aeee175bb793fa095e2192e57ef5d0");
...
const string strMessageMagic = "AlasCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // AlasCoin: 1 days
static const int64 nTargetSpacing = 120; // AlasCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal alascoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "AlasCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x16dc87da1a14592eafba47c9e4b8f6d6768b880a53426e0c6bebe8bcb12f3147");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "skynews 1/5/18 us braces for coldest night in its history";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1515465605; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 338696;

        if (fTestNet)
        {
            block.nTime    = 1515218914;
            block.nNonce   = 999804;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x730258d280c6b744a79ac2e8bc9cf9fefc1eacb9cbec1149062470eb9f89d9bc"));
